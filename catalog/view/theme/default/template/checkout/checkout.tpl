...
<div class="container">        
	...
	<div class="row " >
		<div class="col-md-12">
			...
			<div class="login-form registerbox clearfix well" style="display:none">
				<div class="row">
	...
	<div class="row box checkout_form well" style="margin: 0px;">
			...
			success: function(json) {
				...
				if (json['redirect']) {
					...
					if (json['error']['warning']) {
						...
						$.scrollTo('.checkout_form',400,{offset:-200})
					}
